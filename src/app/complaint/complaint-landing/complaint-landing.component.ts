...
@Component({
  selector: 'app-complaint-landing',
  templateUrl: './complaint-landing.component.html',
  styleUrls: ['./complaint-landing.component.css']
})
export class ComplaintLandingComponent implements OnInit {
